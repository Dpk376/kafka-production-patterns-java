...
public interface OutboxEventRepository extends JpaRepository<OutboxEvent, UUID> {
  ...
  @Query("UPDATE OutboxEvent e SET e.publishedAt = CURRENT_TIMESTAMP WHERE e.eventId = :eventId")
  void markPublished(@org.springframework.data.repository.query.Param("eventId") UUID eventId);
}
